...
import org.usfirst.frc3707.Creedence.commands.climb;
 ...
 *
 */
public class roboClimb extends Subsystem {
    ...
    private PWMVictorSPX winch;
    private PWMVictorSPX grabber;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public roboClimb() {
        winch = new PWMVictorSPX(Constants.Winch);
        addChild("winch", winch);
        winch.setInverted(false);

        grabber = new PWMVictorSPX(Constants.Grabber);
