...
public class hatchGrabber extends Subsystem {
    ...
    private DoubleSolenoid clawClamp = new DoubleSolenoid(1, 2, 3);
    private DoubleSolenoid thrust = new DoubleSolenoid(1, 0, 1);
    private DigitalInput clawButton1 = new DigitalInput(Constants.clawButton1);
    private DigitalInput clawButton2 = new DigitalInput(Constants.clawButton2);
